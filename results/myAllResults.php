...
<?php
    ...
    //get data from DB
    $query = "SELECT * FROM tbl_resHalfMarathon_217 WHERE tbl_resHalfMarathon_217.id='$id'
              UNION ALL 
              SELECT * FROM tbl_trailrun_217 WHERE tbl_trailrun_217.id='$id' ORDER BY '$rank'";
        ...
        <main>
            <nav>
                <ul>
                    ...
                    <li class="vipNav"><a href="../vip/special/achievments.html">Achievements</a></li>
            ...
            <?php
            echo "<h2> my Results </h2>";
            echo "<section>
                <form action='#' method='get'>
                    <p>Find my result</p>
                    <input type='text' name='id' placeholder='my id...'>
